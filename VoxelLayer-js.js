...
/* harmony import */ var _core_reactiveUtils_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../core/reactiveUtils.js */ "R3wZ");
...
/* harmony import */ var _chunks_vec3f64_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../chunks/vec3f64.js */ "Cy1f");
/* harmony import */ var _Layer_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./Layer.js */ "pqNC");
/* harmony import */ var _VoxelWasmManager_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./VoxelWasmManager.js */ "vbpc");
/* harmony import */ var _mixins_APIKeyMixin_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./mixins/APIKeyMixin.js */ "9G54");
...
/* harmony import */ var _mixins_SceneService_js__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./mixins/SceneService.js */ "lq5k");
/* harmony import */ var _support_arcgisLayerUrl_js__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./support/arcgisLayerUrl.js */ "VLTf");
/* harmony import */ var _support_commonProperties_js__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./support/commonProperties.js */ "IvSi");
/* harmony import */ var _support_VoxelDynamicSection_js__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./support/VoxelDynamicSection.js */ "ytPz");
/* harmony import */ var _support_VoxelSection_js__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./support/VoxelSection.js */ "pG35");
/* harmony import */ var _support_VoxelSlice_js__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./support/VoxelSlice.js */ "ay+M");
/* harmony import */ var _support_VoxelStyle_js__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./support/VoxelStyle.js */ "TIAR");
/* harmony import */ var _support_VoxelVariable_js__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./support/VoxelVariable.js */ "RqMe");
/* harmony import */ var _support_VoxelVolume_js__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./support/VoxelVolume.js */ "0n+O");
/* harmony import */ var _support_VoxelVolumeIndex_js__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./support/VoxelVolumeIndex.js */ "RIjU");
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
const R=_core_Logger_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLogger(" esri.layers.VoxelLayer");let C=class extends(Object(_mixins_SceneService_js__WEBPACK_IMPORTED_MODULE_23__["SceneService"])(Object(_mixins_ArcGISService_js__WEBPACK_IMPORTED_MODULE_19__["ArcGISService"])(Object(_mixins_OperationalLayer_js__WEBPACK_IMPORTED_MODULE_20__["OperationalLayer"])(Object(_mixins_PortalLayer_js__WEBPACK_IMPORTED_MODULE_21__["PortalLayer"])(Object(_mixins_ScaleRangeLayer_js__WEBPACK_IMPORTED_MODULE_22__["ScaleRangeLayer"])(Object(_core_MultiOriginJSONSupport_js__WEBPACK_IMPORTED_MODULE_5__["MultiOriginJSONMixin"])(Object(_mixins_APIKeyMixin_js__WEBPACK_IMPORTED_MODULE_18__["APIKeyMixin"])(_Layer_js__WEBPACK_IMPORTED_MODULE_16__["default"])))))))){constructor(e){super(e),this.serviceRoot="",this.popupEnabled=!0,this.operationalLayerType="Voxel",this.legendEnabled=!0,this.title=null,this.sections=new _core_Collection_js__WEBPACK_IMPORTED_MODULE_1__["default"],this.style=null,this.opacity=1,this.variables=new _core_Collection_js__WEBPACK_IMPORTED_MODULE_1__["default"],this.volumes=new _core_Collection_js__WEBPACK_IMPORTED_MODULE_1__["default"],this.index=null,this.minScale=0,this.maxScale=0,this.type="voxel",this._dbgFlags=new Set,this._handles=new _core_Handles_js__WEBPACK_IMPORTED_MODULE_2__["default"],this.version={major:Number.NaN,minor:Number.NaN,versionString:""}}set url(e){this._set("url",Object(_support_arcgisLayerUrl_js__WEBPACK_IMPORTED_MODULE_24__["sanitizeUrl"])(e,R))}destroy(){this._handles=Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_4__["destroyMaybe"])(this._handles)}dbg(e,t){this._dbgFlags.has(e)&&(3===e?R.error(t):R.warn(t))}load(e){const t=Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_4__["isSome"])(e)?e.signal:null,r=this.loadFromPortal({supportedTypes:["Scene Service"]},e).catch(_core_promiseUtils_js__WEBPACK_IMPORTED_MODULE_6__["throwIfAbortError"]).then((()=>this._fetchService(t))).then((()=>this.serviceRoot=this.url));return this.addResolvingPromise(r),Promise.resolve(this)}getConfiguration(){this._handles.add([Object(_core_reactiveUtils_js__WEBPACK_IMPORTED_MODULE_7__["react"])((()=>this._getRenderMode()),(e=>this._pushRenderModeToWasm(e))),Object(_core_reactiveUtils_js__WEBPACK_IMPORTED_MODULE_7__["react"])((()=>this._getCurrentVariableId()),(e=>this._pushCurrentVariableIdToWasm(e))),Object(_core_reactiveUtils_js__WEBPACK_IMPORTED_MODULE_7__["react"])((()=>this._getDynamicSections()),(e=>this._pushDynamicSectionsToWasm(e))),Object(_core_reactiveUtils_js__WEBPACK_IMPORTED_MODULE_7__["react"])((()=>this._getSlices()),(e=>this._pushSlicesToWasm(e))),Object(_core_reactiveUtils_js__WEBPACK_IMPORTED_MODULE_7__["react"])((()=>this._getSections()),(e=>this._pushSectionsToWasm(e)))]);const e={layerType:this.operationalLayerType,version:this.version.versionString,name:this.title,spatialReference:this.spatialReference,fullExtent:this.fullExtent,volumes:this.volumes.toJSON(),variables:this.variables.toJSON(),index:this.index.toJSON(),sections:this.sections.toJSON(),style:this.style};return e.index&&this.index.isValid()?JSON.stringify(e):""}readVersion(e,t){return super.parseVersionString(e)}_getSections(){const e=[];for(const t of this.sections)e.push(new _support_VoxelSection_js__WEBPACK_IMPORTED_MODULE_27__["default"]({enabled:t.enabled,href:t.href,id:t.id,label:t.label,normal:t.normal,point:t.point,sizeInPixel:t.sizeInPixel,slices:t.slices,timeId:t.timeId,variableId:t.variableId}));return e}_pushSectionsToWasm(e){this.dbg(2,"VoxelLayer._pushSectionsToWasm() called");_VoxelWasmManager_js__WEBPACK_IMPORTED_MODULE_17__["default"].getInstance().setLayerStaticSections(this,e)||this.dbg(3,"VoxelLayer._pushSectionsToWasm() failed!")}_isPlaneValid(e,t,r){if(!e.point)return!1;if(!Array.isArray(e.point)||3!==e.point.length)return!1;if(!e.normal)return!1;if(!Array.isArray(e.normal)||3!==e.normal.length)return!1;for(let o=0;o<3;++o){const i=e.point[o];if(i<0||i>=r[t[o]].size)return!1}const i=Object(_chunks_vec3f64_js__WEBPACK_IMPORTED_MODULE_15__["f"])(e.normal[0],e.normal[1],e.normal[2]);Object(_chunks_vec3_js__WEBPACK_IMPORTED_MODULE_14__["n"])(i,i);const s=1e-6;return!(Math.abs(i[0])+Math.abs(i[1])+Math.abs(i[2])<s)&&(e.normal[0]=i[0],e.normal[1]=i[1],e.normal[2]=i[2],!0)}getVariableStyle(e){let t=-1;t=Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_4__["isSome"])(e)?e:this._getCurrentVariableId();if(!(null==this?void 0:this.style.variableStyles)||-1===t)return null;const r=this.style.variableStyles.findIndex((e=>e.variableId===t));return r<0?null:this.style.variableStyles.getItemAt(r)}getVariable(e){let t=-1;if(t=Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_4__["isSome"])(e)?e:this._getCurrentVariableId(),!this.variables||-1===t)return null;const r=this.variables.findIndex((e=>e.id===t));return r<0?null:this.variables.getItemAt(r)}_getVolume(e){const t=this.getVariable(e);return Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_4__["isSome"])(t)?this.volumes.find((({id:e})=>e===t.volumeId)):null}_getVolumeStyle(e){const t=this.getVariable(e);return Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_4__["isSome"])(t)?this.style.volumeStyles.find((({volumeId:e})=>e===t.volumeId)):null}_getSlices(){const e=[],t=this._getVolume(null);if(!Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_4__["isSome"])(t)||!t.isVolumeValid())return e;const r=this._getVolumeStyle(null);if(!Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_4__["isSome"])(r))return e;for(const i of r.slices)this._isPlaneValid(i,[0,1,t.getZDimension()],t.dimensions)?e.push(new _support_VoxelSlice_js__WEBPACK_IMPORTED_MODULE_28__["default"]({enabled:i.enabled,label:i.label,point:i.point,normal:i.normal})):e.push(new _support_VoxelSlice_js__WEBPACK_IMPORTED_MODULE_28__["default"]({enabled:!1,label:"invalid",point:i.point,normal:i.normal}));return e}_pushSlicesToWasm(e){this.dbg(2,"VoxelLayer._pushSlicesToWasm() called!");_VoxelWasmManager_js__WEBPACK_IMPORTED_MODULE_17__["default"].getInstance().setLayerSlices(this,e)||this.dbg(3,"VoxelLayer._pushSlicesToWasm() failed!")}_getDynamicSections(){const e=[],t=this._getVolume(null);if(!Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_4__["isSome"])(t)||!t.isVolumeValid())return e;const r=this._getVolumeStyle(null);if(!Object(_core_maybe_js__WEBPACK_IMPORTED_MODULE_4__["isSome"])(r))return e;for(const i of r.dynamicSections)this._isPlaneValid(i,[0,1,t.getZDimension()],t.dimensions)?e.push(new _support_VoxelDynamicSection_js__WEBPACK_IMPORTED_MODULE_26__["default"]({enabled:i.enabled,label:i.label,point:i.point,normal:i.normal})):e.push(new _support_VoxelDynamicSection_js__WEBPACK_IMPORTED_MODULE_26__["default"]({enabled:!1,label:"invalid",point:i.point,normal:i.normal}));return e}_pushDynamicSectionsToWasm(e){this.dbg(2,"VoxelLayer._pushDynamicSectionsToWasm() called!");_VoxelWasmManager_js__WEBPACK_IMPORTED_MODULE_17__["default"].getInstance().setLayerDynamicSections(this,e)||this.dbg(3,"VoxelLayer._updateDynamicSections() failed!")}_getCurrentVariableId(){return this.style?this.style.currentVariableId:-1}_pushCurrentVariableIdToWasm(e){this.dbg(2,"VoxelLayer._pushCurrentVariableIdToWasm() called!");_VoxelWasmManager_js__WEBPACK_IMPORTED_MODULE_17__["default"].getInstance().setLayerCurrentVariable(this,e)||this.dbg(3,"VoxelLayer._pushCurrentVariableIdToWasm() failed!")}_getRenderMode(){return this.style?this.style.renderMode:"volume"}_pushRenderModeToWasm(e){this.dbg(2,"VoxelLayer._pushRenderModeToWasm() called!");_VoxelWasmManager_js__WEBPACK_IMPORTED_MODULE_17__["default"].getInstance().setLayerRenderMode(this,e)||this.dbg(3,"VoxelLayer.setLayerRenderMode() failed!")}};Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_8__["property"])(_support_commonProperties_js__WEBPACK_IMPORTED_MODULE_25__["popupEnabled"])],C.prototype,"popupEnabled",void 0),Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_8__["property"])({type:["Voxel"]})],C.prototype,"operationalLayerType",void 0),Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_8__["property"])(_support_commonProperties_js__WEBPACK_IMPORTED_MODULE_25__["legendEnabled"])],C.prototype,"legendEnabled",void 0),Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_8__["property"])({json:{write:!0}})],C.prototype,"title",void 0),Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_8__["property"])(_support_commonProperties_js__WEBPACK_IMPORTED_MODULE_25__["url"])],C.prototype,"url",null),Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_8__["property"])({type:_core_Collection_js__WEBPACK_IMPORTED_MODULE_1__["default"].ofType(_support_VoxelSection_js__WEBPACK_IMPORTED_MODULE_27__["default"]),json:{write:!0,origins:{"web-scene":{name:"layerDefinition.sections",write:!0},service:{write:!1}}}})],C.prototype,"sections",void 0),Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_8__["property"])({type:_support_VoxelStyle_js__WEBPACK_IMPORTED_MODULE_29__["default"],json:{write:!0,origins:{"web-scene":{name:"layerDefinition.style",write:!0},service:{write:!1}}}})],C.prototype,"style",void 0),Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_8__["property"])({type:["show","hide"]})],C.prototype,"listMode",void 0),Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_8__["property"])({type:Number,range:{min:0,max:1},nonNullable:!0,json:{read:!1,write:!1,origins:{"web-scene":{read:!1,write:!1},"portal-item":{read:!1,write:!1}}}})],C.prototype,"opacity",void 0),Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_8__["property"])({type:_core_Collection_js__WEBPACK_IMPORTED_MODULE_1__["default"].ofType(_support_VoxelVariable_js__WEBPACK_IMPORTED_MODULE_30__["default"])})],C.prototype,"variables",void 0),Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_8__["property"])({type:_core_Collection_js__WEBPACK_IMPORTED_MODULE_1__["default"].ofType(_support_VoxelVolume_js__WEBPACK_IMPORTED_MODULE_31__["default"])})],C.prototype,"volumes",void 0),Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_8__["property"])({type:_support_VoxelVolumeIndex_js__WEBPACK_IMPORTED_MODULE_32__["default"]})],C.prototype,"index",void 0),Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_8__["property"])({type:Number,json:{name:"layerDefinition.minScale",read:!1,write:!1,origins:{service:{read:!1,write:!1}}}})],C.prototype,"minScale",void 0),Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_8__["property"])({type:Number,json:{name:"layerDefinition.maxScale",read:!1,write:!1,origins:{service:{read:!1,write:!1}}}})],C.prototype,"maxScale",void 0),Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_8__["property"])({json:{read:!1},readOnly:!0})],C.prototype,"type",void 0),Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_property_js__WEBPACK_IMPORTED_MODULE_8__["property"])({readOnly:!0,json:{name:"serviceVersion"}})],C.prototype,"version",void 0),Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_reader_js__WEBPACK_IMPORTED_MODULE_12__["reader"])("service","version")],C.prototype,"readVersion",null),C=Object(_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__["_"])([Object(_core_accessorSupport_decorators_subclass_js__WEBPACK_IMPORTED_MODULE_13__["subclass"])("esri.layers.VoxelLayer")],C);const P=C;
